...
<div class="main">
  <div style=" background-color:white; padding-left:15px; padding-top:20px; ">
    ...
    <table id="maintable">
      <tr>
        <th scope="col"><label class="containerv2" style="  padding-left:40px; margin-top:-11px; width: 30px;">#
            <input type="checkbox">
...
<script>
  function insert_form() {
    ...
    form.action = "master/gem_clarity/insert";
  }
  ...
  function edit_form(code, name, detail, uid) {
    ...
    form.action = "master/gem_clarity/edit/" + uid;
  ...
  function delete_form(uid) {
    if(confirm('คุณต้องการแก้ไขข้อมูลหรือไม่')){
      let form = document.getElementById('main_form');
      form.action = "master/gem_clarity/delete/" + uid;
      form.submit();
    }
  }
