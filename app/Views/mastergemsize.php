  ...
  <div style="background-color:white; padding-left:30px; ">
    <div class="row" style="padding-top:20px; ">
      <div class="col-4">
        ...
        <input type="text" id="large-inputv2" class="form-control mb-3" style="width: 477px;height: 45px;" placeholder="รหัส Code">
        <lebel>ชื่อ</lebel></br>
        <input type="text" id="large-inputv2" class="form-control mb-3" style="width: 477px;height: 45px;" placeholder="ชื่อ">
