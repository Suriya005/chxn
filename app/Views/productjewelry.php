...
<div class="col-1" style="margin-left:20px;"><button type="button" class="btnchxsave" style="width:150px; "  data-bs-toggle="modal" data-bs-target="#exampleModal" disabled>บันทึก</button></div>
</div>
...
<div class="main" >
  <div class="producthead">
    <div class="row">
      ...
      <div class="col-4"><p style="margin-top: 16px; padding:0px;">ข้อมูลอัญมณี/เพชร</p></div>
    </div>
  </div>
...
<div class="totaldiv">
    <div id="showtotaldiv">
      <div align="right"><div id="closetotaldiv" align="center"><img src="assets/image/icon/aa.png" class="totalimg"></div></div>
      <div class="indetail">
      <div class="row">
