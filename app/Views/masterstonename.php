...
<div class="col-9"><a style="font-size:25px;font-weight: 500;color: #2A2A2A;">มาสเตอร์ ชื่ออัญมณี / เพชร</a></div>
...
<div style=" background-color:white; padding-left:20px; ">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="รายละเอียด" style="width:477px; height:128px;"></textarea>
        </div>
    <div class="col-4">
    <div style="margin-top:47px;"></div>
        <label>กลุ่มอัญมณี</label></br>
        <select class="form-select" id="large-inputv2">
