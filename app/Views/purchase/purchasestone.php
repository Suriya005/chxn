...
<div class="col-10"><a style="font-size:25px;font-weight: 500;color: #2A2A2A;">การจัดซื้อ (Purchase) อัญมณี / เพชร</a></div>
...
<div class="saletap">
  <div class="saletap-item" style="    margin-left: 80px;">
    ...
    <input type="text" class="form-control" placeholder="PU-JW050001" readonly>
  </div>
