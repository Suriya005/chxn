...
<div class="col-10"><a style="font-size:25px;font-weight: 500;color: #2A2A2A;">การออม อัญมณี / เพชร</a></div>
...
<div class="saletap" style="width:2748px;">
  <div class="saletap-item" style="    margin-left: 80px;">
    <label for="">เลขที่ใบงาน</label></br>
    <input type="text" class="form-control" placeholder="SV-ST040001" readonly>
  </div>

  <div class="saletap-item">
    <label>วันที่</label></br>
    <input type="date" name="datestart" class="form-control mb-2 " style="padding-left:40px;background-color: white; " value="กรุณาเลือก" /><span><img src="<?php echo base_url('assets/image/icon/calendar-5.png'); ?>" class="iconsalecalenda"></span>
  </div>
  <div class="saletap-item">
    <label>วันที่ครบกำหนด</label></br>
    <input type="date" name="dateend" class="form-control mb-2 " style="padding-left:40px;background-color: white; " value="กรุณาเลือก" /><span><img src="<?php echo base_url('assets/image/icon/calendar-5.png'); ?>" class="iconsalecalenda"></span>
  </div>
...
<div class="main" style="height: 381px; width: 2748px; position: relative;">

<div class="purchasehead">
<span style="margin-right:25px;margin-left:15px;">รูป</span>
  <span style="margin-right:105px;">กลุ่มอัญมณี</span>
  <span style="margin-right:90px;">คลังสินค้า</span>
  <span style="margin-right:20px;">Last No./Memo Ref</span>
  <span style="margin-right: 73px;">รหัสสินค้า Product Code</span>
  <span style="margin-right: 107px;">ขนาด</span>
  <span style="margin-right: 191px;">น้ำหนัก</span>
  <span style="margin-right: 94px;">จำนวน</span>
  <span style="margin-right: 255px;">ราคา</span>
  <span style="margin-right: 182px;">ส่วนลด</span>
  <span style="margin-right: 128px;">ราคารวม</span>
  <span style="margin-right:15px;">หมายเหตุ</span>
</div>

<div class="purchasedetail">
<span>1</span>
<img src="<?php echo base_url('assets/image/icon/plusv.png'); ?>" class="customadd" alt="">
<select  style="width:200px;">
      <option value="" disabled selected>เลือกกลุ่มอัญมณี</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
...
<select  style="width:170px;">
      <option value="" disabled selected>เลือกคลัง</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
...
<select  style="width:191px;">
      <option value="" disabled selected>Last No./Memo Ref</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
...
<select  style="width:281px;">
      <option value="" disabled selected>รหัสสินค้า Product Code</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
      <option>??</option>
...
<input type="text "  style="width: 150px;" placeholder="0.00">
...
<input type="text "  style="width: 150px;" value="เม็ด" >
<input type="text "  style="width: 200px;" placeholder="บาท">
<select  style="width:92px;">
      <option>เม็ด</option>
      <option>??</option>
      <option>??</option>
...
<input type="text "  style="width: 81px;"value="0%" >
<input type="text "  style="width: 150px;" placeholder="0.00 บาท">
<input type="text "  style="width: 200px;"placeholder="บาท">
...
<!-- -----------------------total--------------- -->
<div class="totaldiv" style="bottom: 0px;right: 1080px;">
    <div id="showtotaldiv">
      <div class="row">
