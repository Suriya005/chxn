...
<div class="col-9"><a style="font-size:25px;font-weight: 500;color: #2A2A2A;">Memo Return อัญมณี / เพชร</a></div>




<div class="col-1" ><button type="button" class="memoretuenbtn" data-bs-toggle="modal"  data-bs-target="#Modaltable">รายการ Memo</button></div>





<div class="col-1" style="margin-left:85px;"><button type="button" class="btnchxsave" style="width:150px; "  data-bs-toggle="modal" data-bs-target="#exampleModal" disabled>บันทึก</button></div>
...
<div class="saletap">
  <div class="saletap-item" style="    margin-left: 80px;">
    ...
    <input type="text" class="form-control" placeholder="MEMO-ST040001" readonly>
  </div>
...
<div class="modal fade" id="Modaltable" style="min-width: 1690px;height: 900px; ">
  <div class="modal-dialog modal-dialog-centered" style="min-width: 1690px; height: 900px;">
    <div class="modal-content" style="min-width: 1690px; height: 900px;">
    <div align="center" ><div style="width:250px; margin-top:9px; border-bottom:3px solid #2CBAB5; "><p style="margin-bottom:10px;margin-top:9px;">รายการ Memo</p></div></div>
        ...
        <th rowspan="2"><label class="containerv2" style="  padding-left:40px; margin-top:0px;width: 70px;">#
              <input type="checkbox" >
                <span class="checkmarks" style="left:8px; margin-top:0px;"></span>
            </label></th>
    ...
    <th rowspan="2" style="min-width: 210px;">Memo Ref.</th>
  	<th rowspan="2" style="min-width: 150px;">วันที่</th>
  	<th rowspan="2" style="min-width: 150px;">ประเภทสินค้า</th>
    <th rowspan="2" style="min-width: 100px;">รหัสสินค้า Product Code</th>
    <th colspan="2" id="inventableblue" style="text-align:center; min-width:250px;">รับเข้า</th>
    <th colspan="2" id="inventablegreen" style="text-align:center;min-width:250px;">คงเหลือ</th>
    ...
    <th colspan="1" id="inventablegreensub">Nwt</th>
        ...
        <tbody>
            ...
            <td ><label class="containerv2" style="  padding-left:40px; margin-top:0px;width: 70px;">1
              <input type="checkbox" >
                <span class="checkmarks" style="left:8px; margin-top:0px;"></td>
              <td>PU-JW04001</td>
              <td>Ref-01</td>
              <td>-</td>
            ...
            <tr>
            <td ><label class="containerv2" style="  padding-left:40px; margin-top:0px;width: 70px;">2
              <input type="checkbox" >
                <span class="checkmarks" style="left:8px; margin-top:0px;"></td>
              <td>PU-JW04001</td>
              <td>Ref-01</td>
            ...
            <tr>
            <td ><label class="containerv2" style="  padding-left:40px; margin-top:0px;width: 70px;">3
              <input type="checkbox" >
                <span class="checkmarks" style="left:8px; margin-top:0px;"></td>
              <td>PU-JW04001</td>
              <td>Ref-01</td>
        ...
        <tfoot>
            <tr>
               <th colspan="8" style="border-top: 1px solid #ddd;">
               <button type="button" class="memoretuenbtn" style="margin-left: 15px;">คืน Memo</button>
               </th>
                <th colspan="2" id="inventablebluesub"></th>
                <th colspan="2" id="inventablegreensub"></th>
...
<!-- <div class="modal fade" id="memomodals" >
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" >
    <div align="center" ><div style="width:250px; border-bottom:3px solid #2CBAB5; "><p style="margin-bottom:10px;margin-top:10px;">รายการ Memo</p></div></div>
    </div>
  </div>
</div> -->
...
<!-- Modal table -->
<div class="modal" id="MemoModal" tabindex="-1">
   <div class="modal-dialog modal-dialog-centered" id="simpleModal" style="max-width:1690px; " >
...
<!--
            ...
            <div class="row">
              <div class="col-6" align="left">
                <div class="row">
                  <div class="col-1">
                  <img src="<?php //echo base_url('assets/image/icon/user-3.png'); ?>"  style="width:24px;">
                  </div>
                  <div class="col-1">
                  <p style="width:46px; margin-top:3px;">คู่ค้า</p>
                  </div>
                  <div class="col-4">
                  <select name="" id=""  style="width:340px; height:45px;    margin-top: 6px; border:1px solid grey; border-radius:5px;">
                  <option value="">Jeweal Prosoft Co., Ltd.</option>
                  <option value="">test</option>
                  </select>
                  </div>
              ...
              <div class="row">
                <div class="col-6"><p style="width:46px; margin-top:3px;"></p>วันที่</p></div>
                <div class="col-2"><input type="date" style="width:340px; height:45px; border:1px solid grey; border-radius:5px;"></div>
              </div>
  ...
  <tr >
    ...
    <th rowspan="2">เลขที่อ้างอิง 1</th>
  	<th rowspan="2">เลขที่อ้างอิง 2</th>
    <th rowspan="2">Memo Ref.</th>
  	<th rowspan="2">วันที่</th>
  	<th rowspan="2">กลุ่มอัญมณี</th>
  	<th rowspan="2">รหัสอัญมณี Stone Code</th>
    <th colspan="2">Memo In</th>
