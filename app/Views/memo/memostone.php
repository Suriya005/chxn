...
<div class="col-6"><a style="font-size:25px;font-weight: 500;color: #2A2A2A;">คลัง Purchase อัญมณี / เพชร</a></div>
...
<div class="main" style="overflow-x: scroll; padding:0px; height:785px;     padding-right: 15px;" >
<table id="inventable" >
        <thead>
        <tr >
    ...
    <th rowspan="2" style="min-width: 100px;">Memo Ref.</th>
  	<th rowspan="2" style="min-width: 150px;">วันที่</th>
  	<th rowspan="2" style="min-width: 150px;">กลุ่มอัญมณี</th>
  	<th rowspan="2" style="min-width: 150px;">รหัสอัญมณี</th>
    <th colspan="4" id="inventableblue" style="text-align:center;">Memo In</th>
    <th colspan="4" id="inventablepink" style="text-align:center;">จัดซื้อ</th>
    <th colspan="4" id="inventableyellow " style="text-align:center ; color:white; background-color:#FFC164; min-width: 465px; border-bottom: none;" >ออม</th>
    <th colspan="4" id="inventablepurple" style="text-align:center;">Job</th>
    <th colspan="4" id="inventablered" style="text-align:center;">ขาย</th>
    <th colspan="4" id="inventabledeep" style="text-align:center;">คืน</th>
    <th colspan="4" id="inventablegreen" style="text-align:center;">คงเหลือ</th>

  </tr>
  <tr >
    <th colspan="1" id="inventablebluesub">จำนวน</th>
    <th colspan="1" id="inventablebluesub">น.น</th>
    <th colspan="1" id="inventablebluesub">ราคา/หน่วย</th>
    <th colspan="1" id="inventablebluesub">ราคา</th>

    <th colspan="1" id="inventablepinksub">จำนวน</th>
    <th colspan="1" id="inventablepinksub">น.น</th>
    <th colspan="1" id="inventablepinksub">ราคา/หน่วย</th>
    <th colspan="1" id="inventablepinksub">ราคา</th>

    <th colspan="1" id="inventableyellowsub">จำนวน</th>
    <th colspan="1" id="inventableyellowsub">น.น</th>
    <th colspan="1" id="inventableyellowsub">ราคา/หน่วย</th>
    <th colspan="1" id="inventableyellowsub">ราคา</th>

    <th colspan="1" id="inventablepurplesub">จำนวน</th>
    <th colspan="1" id="inventablepurplesub">น.น</th>
    <th colspan="1" id="inventablepurplesub">ราคา/หน่วย</th>
    <th colspan="1" id="inventablepurplesub">ราคา</th>

    <th colspan="1" id="inventableredsub">จำนวน</th>
    <th colspan="1" id="inventableredsub">น.น</th>
    <th colspan="1" id="inventableredsub">ราคา/หน่วย</th>
    <th colspan="1" id="inventableredsub">ราคา</th>

    <th colspan="1" id="inventabledeepsub">จำนวน</th>
    <th colspan="1" id="inventabledeepsub">น.น</th>
    <th colspan="1" id="inventabledeepsub">ราคา/หน่วย</th>
    <th colspan="1" id="inventabledeepsub">ราคา</th>

    <th colspan="1" id="inventablegreensub">จำนวน</th>
    <th colspan="1" id="inventablegreensub">น.น</th>
    <th colspan="1" id="inventablegreensub">ราคา/หน่วย</th>
    <th colspan="1" id="inventablegreensub">ราคา</th>
        ...
        <tbody>
            ...
            <tr>
              <td ><label class="containerv2" style="  padding-left:40px; margin-top:0px;width: 70px;">4
              <input type="checkbox" >
                <span class="checkmarks" style="left:8px;"></span>
            </label></td>
              <td>MEMO-ST04001</td>
            ...
            <tr>
              <td ><label class="containerv2" style="  padding-left:40px; margin-top:0px;width: 70px;">5
              <input type="checkbox" >
                <span class="checkmarks" style="left:8px;"></span>
            </label></td>
              <td>MEMO-ST04001</td>
