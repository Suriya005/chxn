...
<table id="inventable" >
    ...
    <th colspan="4" id="inventableblue" style="text-align:center;">รับเข้า</th>
    ...
    <th colspan="1" id="inventablegreensub">ราคา</th>
        ...
        <tbody>
            <tr>
              ...
              <td id="tdblue">5,000.00</td>
              <td id="tdblue">500,000.00</td>

              <td id="tdyellow">100</td>
              <td id="tdyellow">49.00</td>
              <td id="tdyellow">,</td>
              <td id="tdyellow">500,000.00</td>

              <td id="tdpurple">100</td>
              <td id="tdpurple">49.00</td>
              <td id="tdpurple">,</td>
              <td id="tdpurple">500,000.00</td>

              <td id="tdred">100</td>
              <td id="tdred">49.00</td>
              <td id="tdred">,</td>
              <td id="tdred">500,000.00</td>

              <td id="tdgreen">100</td>
              <td id="tdgreen">49.00</td>
              <td id="tdgreen">,</td>
              <td id="tdgreen"> 500,000.00</td>
            </tr>
        ...
        <tfoot>
            <tr>
               <th colspan="9" style="border-top: 1px solid #ddd;" ></th>
                ...
                <th id="inventableyellowsub">98.00</th>
        
                <th colspan="1" id="inventableyellowsub"></th>
                <th id="inventableyellowsub">1,000,000.00</th>


                <th id="inventablepurplesub">200</th>
                <th id="inventablepurplesub">98.00</th>
        
                <th colspan="1" id="inventablepurplesub"></th>
                <th  id="inventablepurplesub">1,000,000.00</th>
