...
<div class="col-4"><a style="font-size:25px;font-weight: 500;color: #2A2A2A;">คลังออเดอร์ซ่อม</a></div>
<div class="col-1" style="margin-right: 120px;"><button class="memobtn" data-bs-toggle="modal"  data-bs-target="#Modaltable">ออเดอซ่อม</button><img src="<?php echo base_url('assets/image/icon/Custom-2.png'); ?>" class="btnordericon"></div>
...
<div class="modal fade" id="Modaltable" style="min-width: 1410px; min-height: 809px; ">
  <div class="modal-dialog modal-dialog-centered" style="min-width: 1410px; height: 809px;">
    ...
    <div align="center" ><div style="width:250px; margin-top:9px; border-bottom:3px solid #2CBAB5; "><p style="margin-bottom:10px;margin-top:9px;">ออเดอร์ซ่อม</p></div></div>
